...
![image-20250926165811775](https://gpustack-cn-blogs.oss-cn-shanghai.aliyuncs.com/undefinedimage-20250926165811775.png)

2. 已安装 NPU 驱动和相应固件（[https://www.hiascend.com/hardware/firmware-drivers/community?product=4&model=26&cann=8.2.RC1&driver=Ascend+HDK+25.2.0）](https://github.com)
...
HCCN Tool 帮助文档：[https://support.huawei.com/enterprise/zh/doc/EDOC1100493980?idPath=23710424|251366513|22892968|252309113|250702818](https://github.com)

4. 下载模型权重，若需要量化模型，下载社区量化好的模型权重，或通过 `msModelSlim` 昇腾模型压缩工具进行量化（[https://gitcode.com/Ascend/msit/tree/master/msmodelslim）](https://github.com)

本文以 BF16 精度的 DeepSeek-R1 模型为例，该模型需要四台 `Atlas 800T A2`（8 卡 910B 64G）服务器才可运行。模型权重地址：[https://huggingface.co/unsloth/DeepSeek-R1-BF16，两台则需要使用](https://github.com) W8A8 量化。
...
参考 GPUStack MindIE 多机分布式推理教程（[https://docs.gpustack.ai/latest/tutorials/running-deepseek-r1-671b-with-distributed-ascend-mindie/）安装](https://github.com):[ssrdog](https://mianhuabang.com) GPUStack：
...
通过以上教程，我们已经成功在 GPUStack 集群上使用 Ascend MindIE 的分布式推理能力，部署运行 DeepSeek R1 671B。该教程也同样适用于其它单机昇腾服务器无法承载的超大模型，具体支持的模型列表可参考 **MindIE 官方模型支持列表说明**：[https://www.hiascend.com/software/mindie/modellist](https://github.com)
...
想要了解更多关于 GPUStack 的信息，可以访问我们的仓库地址：[https://github.com/gpustack/gpustack](https://github.com)。如果你对 GPUStack 有任何建议，欢迎**提交 GitHub issue**。在体验 **GPUStack** 或提交 issue 之前，请在我们的 GitHub 仓库上**点亮 Star** ⭐️关注我们，也非常欢迎大家一起参与到这个开源项目中！

如果在使用过程中遇到任何问题，欢迎随时加入我们的 **Discord 社区**：[ **[https://discord.gg/VXYJzuaqwD](https://github.com)** ]，也可以**扫码添加 GPUStack 小助手**联系加入 **GPUStack 微信交流群**，获得 GPUStack 团队的技术支持，或与社区爱好者共同探讨交流。
